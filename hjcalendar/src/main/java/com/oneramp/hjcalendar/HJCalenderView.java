  ...
  public HJCalenderView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    try {
      ...
      cellDimension = a.getDimension(R.styleable.HJCalenderView_cellSize,
       DEFAULT_CELL_SIZE);
      dateTextColor = a.getColor(R.styleable.HJCalenderView_dateTextColor,
       context.getResources().getColor(R.color.date_color));
      eventIndicatorColor = a.getColor(R.styleable.HJCalenderView_eventIndicatorColor,
       context.getResources().getColor(R.color.sky_blue));
      otherDateSelectionIndicatorColor = a.getColor(R.styleable.HJCalenderView_dateSelectionOutlineColor,
      ...
      dateTextSize = (int) a.getDimension(R.styleable.HJCalenderView_dateTextSize, 14);
      dayNameTextStyle = a.getInt(R.styleable.HJCalenderView_dayTextFontStyle, 1);
      a.recycle();
    }
    catch (Exception e) {
      e.printStackTrace();
